...
describe Ticket do
	...
	def create_tickets
		@valid_metrics = ['id', 'ticket_id', 'url', 'group_stations', 'assignee_stations', 'reopens', 'replies', 'assignee_updated_at', 
		...
		@valid_info = ['id', 'url', 'external_id', 'type', 'subject', 'raw_subject', 'description', 'priority', 'status', 'recipient', 'requester_id',			
			...
			'allow_channelback', 'is_public', 'created_at', 'updated_at]
